 ...
 */
public class FindItemsByKeywordsRequestResponse {
	/**
	 ...
	 * category histogram is not returned if the search query returns no matching items. CategoryHistogram
	 */
	 ...
	 * in search results are included in a site's histogram counts. ConditionHistogram
	 */
