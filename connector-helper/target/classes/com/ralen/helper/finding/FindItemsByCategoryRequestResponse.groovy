 ...
 * categoryId).
 */
public class FindItemsByCategoryRequestResponse {
	/**
	 * Response container for aspect histograms. Aspect histograms are returned for categories. AspectHistogram
	 */
	 ...
	 * children categories. CategoryHistogram
	 */
