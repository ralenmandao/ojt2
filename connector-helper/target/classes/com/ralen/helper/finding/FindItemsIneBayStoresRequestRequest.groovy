...
/**
 * This call searches for items in the eBay store inventories. You can combine storeName with keywords to find
 * specific items, or use keywords without storeName to search for items in all eBay stores.
 */
public class FindItemsIneBayStoresRequestRequest {
	/**
	 ...
	 * You must specify keywords when you are searching across all eBay stores. That is, is required if is not
	 * specified in the request. 350. The maximum length for a single word is 98. 2.
	 */
	String keywords
	/**
	 ...
	 * for specific items in an eBay store. If you do not specify keywords, you must specify storeName. If you do not
	 * specify in the request, the search is across all eBay stores. When searching across all stores, you must
	 * specify keywords. The results can be filtered by item listing details or aspects.
	 */
	String storeName
	/**
